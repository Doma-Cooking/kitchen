...
const PROMPT_DIR = join(import.meta.dirname, "../src/cookbook/implementation/prompt");
const PROMPT_OUTPUT = join(PROMPT_DIR, "prompts.generated.ts");

const TEMPLATE_DIR = join(import.meta.dirname, "../src/cookbook/implementation/template");
