...
const SHARED_STYLES = `
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    [data-theme="dark"] .active-panel th { color: #666; }
    [data-theme="dark"] .active-panel .section-label { color: #666; }
    [data-theme="dark"] .active-panel .empty { color: #555; }
    ...
    [data-theme="dark"] th { background: #222; color: #888; }
